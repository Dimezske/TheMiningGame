...
func _on_health_updated(health, _amount):
	...
	health_bar_tween.interpolate_property(health_under, "value", health_under.value, health, 0.4, Tween.TRANS_SINE, Tween.EASE_IN_OUT)
...
func _assign_color(health):
	...
	elif health < health.over.max_value * caution_zone:
